      ...
      <div className="max-w-6xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            <Link to="/historia" className="text-gray-400 hover:text-white transition text-sm">Historia</Link>
            <Link to="/contactanos" className="text-gray-400 hover:text-white transition text-sm">Trabaja con nosotros</Link>
            <Link to="/contactanos" className="text-gray-400 hover:text-white transition text-sm">Ventas corporativas</Link>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <Link to="/contactanos" className="text-gray-400 hover:text-white transition text-sm">Contáctanos</Link>
          </div>
        </div>
