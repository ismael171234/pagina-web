...
import { FiEye, FiEyeOff, FiLock, FiCheck, FiX, FiAlertCircle } from 'react-icons/fi'
...
function ResetPassword() {
  ...
  const { actualizarPassword, cerrarSesion, usuario, cargando: authCargando } = useAuth()
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Cerrar la sesión temporal para que la redirección a /login funcione limpiamente
      await cerrarSesion()
        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          {authCargando ? (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-500 text-sm font-semibold">Cargando sesión de seguridad...</p>
            </div>
          ) : !usuario ? (
            <div className="text-center py-6">
              ...
              <p className="text-gray-500 text-sm mb-6 leading-relaxed">
                El enlace de recuperación es de un solo uso o ha caducado. Por favor, solicita un nuevo enlace desde la pantalla de inicio de sesión.
              </p>
              <button
                onClick={() => navigate('/login')}
                className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3 rounded-xl transition shadow-md active:scale-95"
              >
